...
class RemoveCustomerDialog extends StatefulWidget {
  ...
  @override
  State<RemoveCustomerDialog> createState() => _RemoveCustomerDialogState();
}
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Are you sure you want to remove ${widget.customerName}? Select a removal reason to proceed.',
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.trim().isEmpty) {
                            return 'Please enter a removal reason';
                          }
                          return null;
                        },
                        onChanged: (_) {
